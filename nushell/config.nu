...
# Disables startup welcome banner
...
# Stops Nushell from sending OSC 133 sequences that force WezTerm to scroll down
$env.config.shell_integration.osc133 = false

# Stops Nushell from recalculating right prompt layout on every keypress
